...
% /opt/intel/oneapi
% with the MKL libraries in /opt/intel/oneapi/mkl/2023.2.0
%
...
% cd /opt/intel/oneapi/mkl/2023.2.0/tools/builder
...
%
% For Mac:
% cp libsingle_mkl_ilp64* MATLAB_ROOT/extern/lib/maca64
% cp libsingle_mkl_ilp64* /Applications/MATLAB_R2023a.app/extern/lib/maca64
% cp libsingle_mkl_ilp64* /Applications/MATLAB_R2023a.app/bin/maca64
%
% For Linux 64 bit:
...
for b = 1:3
   ...
   switch arch
      ...
      case {'maca64'}
         switch name
            ...
            case 'mmx_mkl_multi'
               root     = matlabroot;
               inc_dir  = [root '/extern/lib/maca64'];
               link     = {'mwblas','mwlapack','pthread'};
               define   = {'UNIX_SYSTEM','USE_BLAS'};
               
            case 'mmx_mkl_single'
               root     = '/opt/intel/oneapi/mkl/2023.2.0';
               inc_dir  = [ root '/include'];
               link_dir = [matlabroot '/extern/lib/maca64'];
   ...
   if ~isempty(link_dir)
      if strcmp(arch,'glnxa64') || strcmp(arch,'maca64')
